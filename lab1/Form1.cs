    ...
    public partial class Form1 : Form
    {
        ...
        private void encodeButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                record("Ñîîáùåíèå " + input + " çàêîäèğîâàíî â ", $"{output} [{outputSecond}]");
            }
            catch
            {
                record("Ñîîáùåíèå íå óäàëîñü", " çàêîäèğîâàòü");
            }
        ...
        private void decodeButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                outputBox.Text = output;
                record("Ñîîáùåíèå " + input + " ğàñêîäèğîâàíî â ", $"{output}");
            }
            catch
            {
                record("Ñîîáùåíèå íå óäàëîñü", " ğàñêîäèğîâàòü");
            }
        }
        private void record(string inputStr, string outputStr)
        {
            ...
            {
                historyBox.Text = "Â ïîëå ââîäà ïóñòî" + "\n" + historyBox.Text;
            }
